...
job_type = 0        # 0 - start new job, 1 - restart
...
input_basis_file = "/work/akanane/users/akanane/Relativistic/GA/cc-pVTZ-pp_uncontracted.bas"
...
if __name__=="__main__":
   ...
   for gen in range(n_gen):
      ...
      if gen == 0 and job_type == 1:
         fo.write(" Restarting previous job. Reading basis sets from job_saved.txt \n")
      ...
      for n, bas in enumerate(bas_mutated):
         ...
         #
         if n==idxn and original_basis_mut and job_type==0:
