...
def main():
   ...
   scratch_dir1      = "/work/akanane/users/kennet/GA/parallel/ga_at/tmp1"
   scratch_dir2      = "/work/akanane/users/kennet/GA/parallel/ga_at/tmp2"
   scratch_dir3      = "/work/akanane/users/kennet/GA/parallel/ga_at/tmp3"
   memory     = 32000   # in mb
   xcf        = "pbe0"
   ...
   for gen in range(n_gen):
	...
	# HAt
         p3 = Process(target=runn.run_many_calc_mol, args=(cal_dir, scratch_dir3, memory, bas, 
                                                  ...
                                                  HAt_geometry, xcf, basenameHAt,H_basis))
